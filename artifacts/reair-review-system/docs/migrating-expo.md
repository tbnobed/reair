# Migrating Expo UI to Re-Air Review System

Read `artifacts/reair-review-system/docs/AGENTS.md` and
`artifacts/reair-review-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/reair-review-system/lib/native-theme` and
  `@workspace/reair-review-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/reair-review-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/reair-review-system` and retains only
