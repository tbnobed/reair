# Consuming Re-Air Review System in Expo apps

Read `artifacts/reair-review-system/docs/AGENTS.md` first. React Native does
...
`artifacts/reair-review-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/reair-review-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/reair-review-system/lib/native-theme";
import { useColors } from "@workspace/reair-review-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/reair-review-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/reair-review-system/components/native/badge";
import { Button } from "@workspace/reair-review-system/components/native/button";
import { Card } from "@workspace/reair-review-system/components/native/card";
```
...
Import and render
`@workspace/reair-review-system/components/native/button`, then run Expo
