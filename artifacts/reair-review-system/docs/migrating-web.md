# Migrating web UI to Re-Air Review System

Read `artifacts/reair-review-system/docs/AGENTS.md` and
`artifacts/reair-review-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/reair-review-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/reair-review-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/reair-review-system/hooks/use-toast`
