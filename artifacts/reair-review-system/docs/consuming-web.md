# Consuming Re-Air Review System in web apps

Read `artifacts/reair-review-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/reair-review-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/reair-review-system/styles.css";
```
...
`node_modules/@workspace/reair-review-system/src/components` to `content`.
...
import { cn } from "@workspace/reair-review-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/reair-review-system/hooks/use-toast";
```
...
`@workspace/reair-review-system/components/ui/button`. Run the app's typecheck
